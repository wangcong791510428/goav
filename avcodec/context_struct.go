...
func (ctxt *Context) SetBitRate(br int32) {
	ctxt.bit_rate = C.long(br)
}
...
func (ctxt *Context) SetFlags(flag int64) {
...
func (ctxt *Context) SetGopSize(br int64) {
	ctxt.gop_size = C.int(br)
}
...
func (ctxt *Context) SetHeight(br int) {
	ctxt.height = C.int(br)
}
...
func (ctxt *Context) SetMaxBFrames(br int64) {
	ctxt.max_b_frames = C.int(br)
}
...
func (ctxt *Context) SetMeRange(smrange int) {
	ctxt.me_range = C.int(smrange)
}

func (ctxt *Context) SetMaxqdiff(qd int) {
	ctxt.max_qdiff = C.int(qd)
}
...
func (ctxt *Context) SetQcompress(qc float64) {
	ctxt.qcompress = C.float(qc)
}
...
func (ctxt *Context) SetQmax(max int) {
	ctxt.qmax = C.int(max)
}
...
func (ctxt *Context) SetQmin(min int) {
	ctxt.qmin = C.int(min)
}
...
func (ctxt *Context) SetThreadCount(br int64) {
	ctxt.thread_count = C.int(br)
}
...
func (ctxt *Context) SetWidth(br int) {
	ctxt.width = C.int(br)
}
...
func (ctxt *Context) SetPixFmt(pf PixelFormat) {
	ctxt.pix_fmt = (C.enum_AVPixelFormat)(pf)
}
